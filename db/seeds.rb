...
ariane_1 = Rocket.create!({ name: "Eagle", destination: "Pluton", description: "Ariane1 is a basic solo rocket in which you have to bring your own food/oxygen", price_per_earthday: "1000$", rating: 4.0, user: jeanpierre, address: "75 Rue d'Aboukir, Paris France" })
require "open-uri"
...
ariane_2 = Rocket.create!({ name: "Wind", destination: "Mars", description: "Ariane2 is a basic multiple guests rocket, bring your food", price_per_earthday: "2000$", rating: 4.2, user: jeanpierre, address: "70 avenue ledru rollin, Paris, France" })
...
ariane_3 = Rocket.create!({ name: "Fire", destination: "Venus", description: "Ariane3 is a medium solo rocket, with all amenities", price_per_earthday: "3000$", rating: 4.3, user: jeanpierre, address: "2 Place du Jeu de Paume, Vienne, France" })
...
ariane_4 = Rocket.create!({ name: "Messenger", destination: "Moon", description: "Ariane4 is a premium solo rocket, with a restaurant module and a chef", price_per_earthday: "4000$", rating: 4.5, user: amine, address: "82 Avenue de la République, Bondy, France" })
...
ariane_5 = Rocket.create!({ name: "Nova", destination: "Saturn", description: "Ariane5 is a premium multiple guests rocket, with a restaurant module and a chef", price_per_earthday: "5000$", rating: 4.6, user: amine, address: "15 Rue René Leroy, Niort, France" })
...
ariane_6 = Rocket.create!({ name: "Zephyra", destination: "Moon", description: "Ariane6 is a confortable rocket, with medium capacity and a restaurant", price_per_earthday: "4500$", rating: 4.4, user: amine, address: "69 Rue des Écoles, Aubervilliers,  France" })
...
ariane_7 = Rocket.create!({ name: "Vega", destination: "Moon", description: "Ariane7 is a large rocket, with high capacity, a restaurant, a night-club and DJ", price_per_earthday: "8000$", rating: 4.3, user: nathanael, address: "85 rue La Boetie, Paris, France" })
...
ariane_8 = Rocket.create!({ name: "Altaïr", destination: "Mars", description: "Ariane8 is a luxury rocket, with small capacity, a dining-room and a cinema", price_per_earthday: "10000$", rating: 4.9, user: nathanael, address: "13 Rue Oscar Roty, Paris, France" })
...
ariane_9 = Rocket.create!({ name: "Icarus", destination: "Pluton", description: "Ariane9 is a premium rocket, with medium capacity, nice furniture, a night-club and DJ", price_per_earthday: "7000$", rating: 4.6, user: mohamed, address: "7 Rue de l'Amazonie, Nantes, France" })
...
ariane_9.photo.attach(io: file, filename: "ariane9.png", content_type: "image/jpg")
  ...
  ariane_10 = Rocket.create!({ name: "Orion", destination: "Venus", description: "Ariane10 is a luxury rocket, with high capacity, a high-end restaurant, a night-club and a Spa", price_per_earthday: "6000$", rating: 4.8, user: mohamed, address: "45 Rue Victor Hugo, Montrouge, France" })
